...
def get_prs_mt_path(high_quality: bool = True, max_pops: bool = False):
    return f'{bucket}/prs/all_combos_prs{"" if high_quality else "_raw"}{"_max_pops" if max_pops else ""}.mt'


def get_clump_sumstats_bm_path(high_quality: bool = True, max_pops: bool = False):
    return f'{public_bucket}/misc/prs/clumped_sumstats{"" if high_quality else "_raw"}{"_max_pops" if max_pops else ""}.bm'


def get_clump_sumstats_col_ht_path(high_quality: bool = True, max_pops: bool = False):
    return f'{public_bucket}/misc/prs/clumped_sumstats{"" if high_quality else "_raw"}{"_max_pops" if max_pops else ""}.cols.ht'
...
def get_prs_bm_path(high_quality: bool = True, max_pops: bool = False):
    return f'{temp_bucket}/prs/prs{"" if high_quality else "_raw"}{"_max_pops" if max_pops else ""}.bm'


def get_prs_assess_ht_path(high_quality: bool = True, max_pops: bool = False):
    return f'{bucket}/prs/assess_prs{"" if high_quality else "_raw"}{"_max_pops" if max_pops else ""}.ht'
